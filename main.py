...
import json
import bcrypt 
# NOTE: Ensure you have bcrypt installed: pip install bcrypt
...
def render(navigate):
    ...
    # --- STEP 1: Enter Email ---
    # st.session_state.reset_email is initialized in main.py
        ...
        with st.form(key='verify_email_form'):
            ...
            if submitted:
                ...
                try:
                    ...
                    # 🔑 FIX: Corrected column name from 'id' to 'user_id'
